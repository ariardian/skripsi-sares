...
<link rel="stylesheet" href="{{ asset('plugins/sares/style.css') }}">
<link href="{{ asset('assets/css/sares.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('assets/css/styleOverride.css') }}" rel="stylesheet" type="text/css" />
...
@switch($page_name)
    ...
    @case('calendar')
        ...
        <link href="{{ asset('plugins/fullcalendar/custom-fullcalendar.advance.css') }}" rel="stylesheet"
            type="text/css" />
    ...
    @case('timeline')
        {{-- Component Timeline --}}
        <link href="{{ asset('assets/css/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('assets/css/components/timeline/custom-timeline.css') }}" rel="stylesheet"
            type="text/css" />
        <style>
            .toggle-code-snippet {
                margin-bottom: 0px;
    ...
    @case('miscellaneous')
        ...
        <link rel="stylesheet" type="text/css"
            href="{{ asset('plugins/table/datatable/custom_dt_miscellaneous.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/forms/theme-checkbox-radio.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('plugins/table/datatable/dt-global_style.css') }}">
    @break
    ...
    @case('date_range_picker')
        ...
        <link href="{{ asset('plugins/bootstrap-range-Slider/bootstrap-slider.css') }}" rel="stylesheet"
            type="text/css">
    @break
